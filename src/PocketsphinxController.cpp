#if 1
#include "PocketsphinxController.h"
#include "pocketsphinx.h"
extern "C"{
    void oe_assert(bool b){}
    int verbose_pocketsphinx = 0;
    int verbose_cmuclmtk = 0;
}
...
std::string PocketsphinxController::decode(std::string dir,std::string file){
    ps_decoder_t *ps;
	cmd_ln_t *config;
	FILE *fh;
    ...
    std::string hmm = dir+"/hmm/en_US/hub4wsj_sc_8k";
    std::string lm = dir+"/lm/en/turtle.DMP";
    std::string dict = dir+"/lm/en/turtle.dic";
    std::string go_forward = dir+"/goforward.raw";
